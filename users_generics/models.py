...
class Users(models.Model):
    ...
    last_name = models.CharField(max_length=200, null=False)
    email = models.EmailField(max_length=200, null=False)
    id_rol = models.ForeignKey(Rol, on_delete=models.CASCADE, related_name='users_id_rol')
    id_identification_type = models.ForeignKey(Id_type, on_delete=models.SET_NULL, null=True, blank=True, related_name='users_id_identification_type')
